  ...
  return (
    <div className="bg-gradient-to-b from-blue-50 to-white min-h-screen pt-20">
      ...
      <div className="container mx-auto px-6 md:px-16 py-12 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            We specialize in crafting tailored web solutions that empower businesses to thrive. Our dedicated team of
            developers, designers, and strategists collaborates to create seamless websites, applications, and
      ...
      >
        ...
        <button
          className="mt-5 px-8 py-4 bg-blue-600 text-white text-lg font-medium rounded-lg shadow-lg hover:bg-blue-700 transition"
