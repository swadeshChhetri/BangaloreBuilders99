    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      ...
      >
        <h2 className="text-2xl font-semibold text-center mb-2">
          <span className="text-blue-600">Log In</span> to BangaloreBuilders99
        </h2>
        ...
        <form onSubmit={handleLogin}>
          ...
          <Link href={"/auth/forgotPassword"} className="text-right text-sm text-blue-600 mb-4 cursor-pointer">
            Forgot Password?
          </Link>
